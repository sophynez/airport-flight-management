public class Planning {
	...
	/*public static void main(String[] args) {
		Station station1 = new Station("id1", 10, 5000, new Position(-180, -20, 0));
		Station station2 = new Station("id2", 10, 5000, new Position(100, 50, 0));
		Station station3 = new Station("id3", 10, 5000, new Position(-100, 30, 0));
		
		Server.annuaireStations.add(station1);
		Server.annuaireStations.add(station2);
		Server.annuaireStations.add(station3);
